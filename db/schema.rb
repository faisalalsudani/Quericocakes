...
ActiveRecord::Schema.define(version: 20171023133458) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.boolean "cake_drip"
    t.string "cake_drip_color", default: [], array: true
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "cookies"
    t.integer "cakesicles"
    t.integer "meringue"
    t.integer "cupcakes"
    t.string "cake_toppings", default: [], array: true
  end
